...
- Brain Atlas: turns graph view into a 3-D shape, but a brain rather than a map. Allowing assigning tags/folders/properties to a zone of the brain for logical clustering. Also has a 2D version that keeps the clusters. 

...
- Grid Explorer: allows searching and scrolling notes, images, pdfs, and other files in a full grid, or grid-preview list. Could make a library book shelf but would need to compare with card view in Bases. -- I guess it doesn't need to be the results of a query and might display non-notes if I have 

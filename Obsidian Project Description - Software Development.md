...
- Tab Panels: similar to above, create "tabs" codeblock and insert as many tabs and content inside as you want. Can add code blocks inside tab panels, but have to swit

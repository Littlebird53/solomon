...
- Running Header: display title and select metadata, progress bar, clickable Windows style file structure tree always visible at the top of each page. -- This looks pretty nice and could provide a small selection of relevant properties, plus add some navigation options, show reading progre
